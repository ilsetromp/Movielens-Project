...
Next, we use ALS to train the model by using the reco$train function.
We start using moderate values for the parameters to prevent overfitting of the model. We will check how this model performs. If it underfits, we can adjust these values. 
